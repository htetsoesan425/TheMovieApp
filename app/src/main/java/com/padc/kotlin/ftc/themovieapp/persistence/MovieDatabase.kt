package com.padc.kotlin.ftc.themovieapp.persistence
...
import com.padc.kotlin.ftc.themovieapp.persistence.daos.MovieDao

@Database(entities = [MovieVO::class], version = 1, exportSchema = false)   //declare entities
